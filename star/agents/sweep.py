...
def verify_state(claims: object, room_files: str = "", years: str = "") -> dict:
    ...
    return {
        ...
        # Both builders feed the SAME verifier agent, so this has to arrive
        # by both roads or a sweep judges by a standard a scene check does not.
        # The claims carry their own years too; this is the draft's whole set,
        # for the desk to see the span it is working across.
        "years": years,
